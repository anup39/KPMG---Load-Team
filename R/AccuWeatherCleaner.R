...
accuWeatherData = read.csv(file = "C:/Users/sayanigupta/Downloads/AccuWeatherData.csv", header = T, sep = ",")
...
for(i in 1:ref*1){
    df[i,1] = m[1]
    df[i,2] = time[i]
    df[i,3] = wday(as.Date(m[1], "%d-%m-%Y"))
    if(wday(as.Date(m[1], "%d-%m-%Y")) != 7 | wday(as.Date(m[1], "%d-%m-%Y")) != 1){
        df[i,4] = 0
    }
    else{
        df[i,4] = 1
...
for(i in (ref+1):(ref*2)){
    df[i,1] = m[2]
    df[i,2] = time[i-ref]
    df[i,3] = wday(as.Date(m[2], "%d-%m-%Y"))
    if(wday(as.Date(m[2], "%d-%m-%Y")) != 7 | wday(as.Date(m[2], "%d-%m-%Y")) != 1){
        df[i,4] = 0
    }
    else{
        df[i,4] = 1
...
for(i in (ref*2+1):(ref*3)){
    df[i,1] = m[3]
    df[i,2] = time[i-ref*2]
    df[i,3] = wday(as.Date(m[3], "%d-%m-%Y"))
    if(wday(as.Date(m[3], "%d-%m-%Y")) != 7 | wday(as.Date(m[3], "%d-%m-%Y")) != 1){
        df[i,4] = 0
    }
    else{
        df[i,4] = 1
...
for(i in (ref*3+1):(ref*4)){
    df[i,1] = m[4]
    df[i,2] = time[i-ref*3]
    df[i,3] = wday(as.Date(m[4], "%d-%m-%Y"))
    if(wday(as.Date(m[4], "%d-%m-%Y")) != 7 | wday(as.Date(m[4], "%d-%m-%Y")) != 1){
        df[i,4] = 0
    }
    else{
        df[i,4] = 1
...
# Amritsar
amritsar1 = accuWeatherData[accuWeatherData$City == "amritsar" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[1], format="%d-%m-%Y"), ]
amritsar2 = accuWeatherData[accuWeatherData$City == "amritsar" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[2], format="%d-%m-%Y"), ]
amritsar3 = accuWeatherData[accuWeatherData$City == "amritsar" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[3], format="%d-%m-%Y"), ]
amritsar4 = accuWeatherData[accuWeatherData$City == "amritsar" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[4], format="%d-%m-%Y"), ]


# Bhatinda
bhatinda1 = accuWeatherData[accuWeatherData$City == "bhatinda" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[1], format="%d-%m-%Y"), ]
bhatinda2 = accuWeatherData[accuWeatherData$City == "bhatinda" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[2], format="%d-%m-%Y"), ]
bhatinda3 = accuWeatherData[accuWeatherData$City == "bhatinda" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[3], format="%d-%m-%Y"), ]
bhatinda4 = accuWeatherData[accuWeatherData$City == "bhatinda" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[4], format="%d-%m-%Y"), ]

# Jalandhar
jalandhar1 = accuWeatherData[accuWeatherData$City == "jalandhar" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[1], format="%d-%m-%Y"), ]
jalandhar2 = accuWeatherData[accuWeatherData$City == "jalandhar" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[2], format="%d-%m-%Y"), ]
jalandhar3 = accuWeatherData[accuWeatherData$City == "jalandhar" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[3], format="%d-%m-%Y"), ]
jalandhar4 = accuWeatherData[accuWeatherData$City == "jalandhar" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[4], format="%d-%m-%Y"), ]

# Ludhiana
ludhiana1 = accuWeatherData[accuWeatherData$City == "ludhiana" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[1], format="%d-%m-%Y"), ]
ludhiana2 = accuWeatherData[accuWeatherData$City == "ludhiana" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[2], format="%d-%m-%Y"), ]
ludhiana3 = accuWeatherData[accuWeatherData$City == "ludhiana" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[3], format="%d-%m-%Y"), ]
ludhiana4 = accuWeatherData[accuWeatherData$City == "ludhiana" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[4], format="%d-%m-%Y"), ]

# Patiala
patiala1 = accuWeatherData[accuWeatherData$City == "patiala" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[1], format="%d-%m-%Y"), ]
patiala2 = accuWeatherData[accuWeatherData$City == "patiala" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[2], format="%d-%m-%Y"), ]
patiala3 = accuWeatherData[accuWeatherData$City == "patiala" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[3], format="%d-%m-%Y"), ]
patiala4 = accuWeatherData[accuWeatherData$City == "patiala" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[4], format="%d-%m-%Y"), ]

# Sangrur
sangrur1 = accuWeatherData[accuWeatherData$City == "sangrur" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[1], format="%d-%m-%Y"), ]
sangrur2 = accuWeatherData[accuWeatherData$City == "sangrur" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[2], format="%d-%m-%Y"), ]
sangrur3 = accuWeatherData[accuWeatherData$City == "sangrur" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[3], format="%d-%m-%Y"), ]
sangrur4 = accuWeatherData[accuWeatherData$City == "sangrur" & as.Date(accuWeatherData$Date, format = "%d-%m-%Y") == as.Date(m[4], format="%d-%m-%Y"), ]
...
setwd("D:/")
write.csv(df, file="AccuDataset.csv", row.names=F)
